...
const IncidentCard = ({ incident }) => {
  ...
  return (
    <Link
      ...
      className={`group block bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 border-l-4 ${accent} p-5 hover:shadow-lg hover:shadow-slate-200/60 dark:hover:shadow-slate-950/40 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer`}
    >
